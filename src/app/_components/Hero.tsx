...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-r from-blue-600 to-blue-400 text-white p-8 pb-2">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
        <div className="max-w-lg space-y-6">
          ...
          <Button className="bg-white text-blue-600 hover:bg-gray-200 transition duration-300 cursor-pointer">
            Quero saber mais
          </Button>
        </div>
